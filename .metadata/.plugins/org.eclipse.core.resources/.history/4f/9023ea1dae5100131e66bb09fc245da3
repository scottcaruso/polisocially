...
public class DataRetrievalService extends IntentService{
	...
	public static final String ZIP_KEY = "ZIP"; //This key is for the user's entered Zip Code. It is appended to the URL below to make the call to the GovTrack API.
